...
class FrecuenciaCardiacaScreen extends StatefulWidget {
  const FrecuenciaCardiacaScreen({super.key});

  @override
  State<FrecuenciaCardiacaScreen> createState() => _FrecuenciaCardiacaScreenState();
}

class _FrecuenciaCardiacaScreenState extends State<FrecuenciaCardiacaScreen> with SingleTickerProviderStateMixin {
...
Future<void> _fetchRegistros({String? fecha}) async {
  ...
  try {
    final uri = Uri.parse('https://ec1bff1533be.ngrok-free.app/api/frecuencias_cardiacas')
    ...
    print('Respuesta del servidor (GET /api/frecuencias_cardiacas): ${response.statusCode} - ${response.body}');
...
Future<void> _submitRegistro() async {
  ...
  final int? valor = int.tryParse(_frecuenciaController.text);
  if (valor == null || valor < 0 || valor > 300) {
    setState(() {
      _mensaje = 'Valor de frecuencia cardíaca inválido (0 - 300)';
    });
    return;
  }
  setState(() {
  ...
  print('Enviando solicitud POST a /api/registros_salud con datos: fecha=$fecha, hora=$hora, tipo=frecuencia_cardiaca, valor=$valor');
  ...
  Future<void> _updateRegistro(int id, DateTime fecha, TimeOfDay hora, int valor) async {
    ...
    try {
      final response = await http.put(
        Uri.parse('https://ec1bff1533be.ngrok-free.app/api/frecuencias_cardiacas/$id'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
          'ngrok-skip-browser-warning': 'true',
      ...
      print('Respuesta del servidor (PUT /api/frecuencias_cardiacas/$id): ${response.statusCode} - ${response.body}');
  ...
  Future<void> _deleteRegistro(int id, String fecha, String hora) async {
    ...
    try {
      ...
      print('Respuesta del servidor (DELETE /api/frecuencias_cardiacas/$id): ${response.statusCode} - ${response.body}');
  ...
  void _showEditDialog(dynamic registro) {
    ...
    final editFrecuenciaController = TextEditingController(text: registro['valor'].toString());
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                TextFormField(
                  controller: editFrecuenciaController,
                  decoration: InputDecoration(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Introduce el valor de frecuencia cardíaca';
                    }
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                final int? valor = int.tryParse(editFrecuenciaController.text);
                if (valor == null || valor < 0 || valor > 300) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Valor de frecuencia cardíaca inválido')),
                  );
                  return;
                }
                Navigator.pop(context);
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            'Confirma la eliminación del registro de frecuencia cardíaca del ${registro['fecha']} a las ${registro['hora'].substring(0, 5)} (ID: ${registro['id']})',
            style: const TextStyle(fontFamily: 'Roboto', color: Colors.black87),
          ),
          actions: [
            TextButton(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Frecuencia Cardíaca (lpm)',
                                    labelStyle: const TextStyle(color: Colors.black87, fontFamily: 'Roboto'),
                                    prefixIcon: Icon(Icons.favorite, color: Colors.blue[700], size: size.width * 0.04),
                                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                                    filled: true,
                                    fillColor: Colors.grey[100],
                                  ),
                        ...
                        children: [
                          ...
                          _isLoading
                              ...
                              : _registros.isEmpty
                                  ? Center(
                                      child: Text(
                                        'No hay registros de frecuencia cardíaca.',
                                        style: TextStyle(
                                          fontSize: size.width * 0.04,
                                          fontFamily: 'Roboto',
                                  ...
                                  : RefreshIndicator(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          final isHigh = valor > 100;
                                          final isLow = valor < 60;
...
class TVGraphScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxY = registros.isNotEmpty
        ...
        : 300.0;
    final yInterval = maxY > 100 ? 50.0 : 25.0;
